...
%			&          &         
	...
	Cards in the memory experiment (E1) use anthropomorphisms (i.e. face-like illustrations) on the back of the cards. To stimulate positive valence I chose to present a smiling face illustration. Several illustrations are developed. On-site questionnaire is conducted during creation of the experiment to determine an icon which is portraying the strongest "happiness" emotion. A previous iteration also contained a female version of the image. It has been excluded to avoid an effect of gender bias. Figure \ref{fig:smiling-icons} shows the 3 versions tested. Version 3 is finally used in the live test run, as it is considered to show \textit{happiness} emotion the strongest.
